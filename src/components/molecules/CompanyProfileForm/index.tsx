...
export const CompanyProfileForm: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-xl font-semibold text-gray-900 mb-1">Thông tin công ty</h3>
        <p className="text-sm text-gray-500">Điền thông tin công ty của bạn để hoàn thiện hồ sơ</p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-5">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Mô tả về công ty của bạn, lĩnh vực hoạt động, sứ mệnh..."
            />
          </div>
        </div>
      </div>
